  ...
  return (
    <div className="pb-12 mb-8 mt-8">
      <div class="w-full p- text-center bg-neutral p-4 sm:p-8" data-aos="fade-up">
        <h5 class="mb-2 text-3xl font-bold text-neutral-50 dark:text-white">
        ...
        <div class="items-center justify-center space-y-4 sm:flex sm:space-y-0 sm:space-x-4">
          <a
            ...
            class="w-full sm:w-auto bg-gray-200 hover:bg-gray-800 focus:ring-4 focus:outline-none focus:ring-gray-300 text-white rounded-lg inline-flex items-center justify-center px-12 py-4 dark:bg-gray-700 dark:hover:bg-gray-600 dark:focus:ring-gray-700">
            <div class="text-left">
