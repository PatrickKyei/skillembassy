...
const ValueBlock = ({ icon, title, description }) => (
  <div className="mb-12 lg:mb-0">
    <div className="block h-full rounded-sm bg-neutral-900 hover:bg-gradient-to-r from-neutral-900 to-neutral-800">
...
>
  ...
  />
  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 9L6.00001 9" />
  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M18 9L18.0001 9" />
</svg>
    ...
    {
      title: "Community",
      description: "Over-communicate, ask for input, share ideas, give everyone ownership.",
      icon: (
        <svg
          xmlns="http://www.w3.org/2000/svg"
          fill="none"
