    ...
    <section className="">
      <div className="my-10 text-center">
        <h1 className="text-3xl font-bold text-neutral-100 mb-4">
          CODE OF <u className="text-yellow-200">CONDUCT</u>
        </h1>
      </div>
      <div className="py-8 mx-auto max-w-screen-x lg:py-16">
        ...
        <div>
          <h2 className="text-neutral-100 text-3xl font-bold mb-8 max-w-xl">
            Our Standards{" "}
          </h2>
          <div className="grid md:grid-cols-2 gap-8" data-aos="fade-right">
            <div className="bg-neutral-900 hover:bg-gradient-to-r from-neutral-900 to-neutral-800 border border-neutral-700 rounded-sm p-8 md:p-12">
              <a
                href="#"
                className="bg-green-100 text-neutral-800 text-xs font-medium inline-flex items-center px-2.5 py-0.5 rounded-md mb-2">
                Acceptable
              </a>
              <h2 className="text-neutral-100 text-2xl font-bold mb-2">
            ...
            <div
              ...
              <ul className="list-disc text-lg font-normal text-neutral-500 mb-4">
                <li>
                ...
                <li>
                  ...
                  information, such as a physical or email address, without
      ...
      <div
        className="bg-neutral-900 hover:bg-gradient-to-r from-neutral-900 to-neutral-800 border border-neutral-700 rounded-sm p-8 md:p-12 mb-8"
        data-aos="fade-up">
        <h2 className="text-neutral-100 text-2xl font-bold mb-2">Scope </h2>
        <p className="text-lg font-normal text-neutral-500 mb-6 break-words">
      ...
      <div
        className="bg-neutral-900 hover:bg-gradient-to-r from-neutral-900 to-neutral-800 border border-neutral-700 rounded-sm p-8 md:p-12 my-8"
        data-aos="fade-up">
        <h2 className="text-neutral-100 text-2xl font-bold mb-2">
          Attribution{" "}
        </h2>
